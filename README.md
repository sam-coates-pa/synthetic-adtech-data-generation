...
Purpose: Baseline simulation of device mobility in the area, no incident or anomalous behaviours.

Features:
- Randomised device movements within a defined city region.
...
Purpose: Adds advanced behaviours: rapid egress, stationary patterns, random seeds for reproducibility.
...
Purpose: Finalises the multi-phase simulation, organizes output, highlights device/event summary.
